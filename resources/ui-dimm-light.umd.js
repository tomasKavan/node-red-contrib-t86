 ...
 * License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License)
 * Copyright 2024 Fonticons, Inc.
 */const $r={prefix:"far",iconName:"lightbulb",icon:[384,512,[128161],"f0eb","M297.2 248.9C311.6 228.3 320 203.2 320 176c0-70.7-57.3-128-128-128S64 105.3 64 176c0 27.2 8.4 52.3 22.8 72.9c3.7 5.3 8.1 11.3 12.8 17.7c0 0 0 0 0 0c12.9 17.7 28.3 38.9 39.8 59.8c10.4 19 15.7 38.8 18.3 57.5L109 384c-2.2-12-5.9-23.7-11.8-34.5c-9.9-18-22.2-34.9-34.5-51.8c0 0 0 0 0 0s0 0 0 0c-5.2-7.1-10.4-14.2-15.4-21.4C27.6 247.9 16 213.3 16 176C16 78.8 94.8 0 192 0s176 78.8 176 176c0 37.3-11.6 71.9-31.4 100.3c-5 7.2-10.2 14.3-15.4 21.4c0 0 0 0 0 0s0 0 0 0c-12.3 16.8-24.6 33.7-34.5 51.8c-5.9 10.8-9.6 22.5-11.8 34.5l-48.6 0c2.6-18.7 7.9-38.6 18.3-57.5c11.5-20.9 26.9-42.1 39.8-59.8c0 0 0 0 0 0s0 0 0 0s0 0 0 0c4.7-6.4 9-12.4 12.7-17.7zM192 128c-26.5 0-48 21.5-48 48c0 8.8-7.2 16-16 16s-16-7.2-16-16c0-44.2 35.8-80 80-80c8.8 0 16 7.2 16 16s-7.2 16-16 16zm0 384c-44.2 0-80-35.8-80-80l0-16 160 0 0 16c0 44.2-35.8 80-80 80z"]};var _=(t=>(t.OnOff="onoff",t.Dimm="dimm",t.DimmTemp="dimm.temp",t))(_||{});const Gr={class:"dimmer-widget"},Xr={class:"name"},Hr={key:0,class:"status"},Vr={key:1,class:"status"},tt=2200,St=6e3,Kr=200,qr=500,Qr=c.defineComponent({__name:"DimmLight",props:{id:{},props:{},state:{}},setup(t){kr.add(Wr,$r);const e=St-tt,n=t,a=h=>{const E="touches"in h?h.touches[0].clientX:h.clientX,P="touches"in h?h.touches[0].clientY:h.clientY,N=v.value.begin.start.x-E,Pt=v.value.begin.start.y-P;return{x:N,y:Pt}},r=()=>({state:!0,level:50,temp:tt}),i=()=>({direction:"none",begin:{start:{x:0,y:0},rect:{width:0,height:0},ballast:r()}}),o=()=>{s(),d.value=setTimeout(Zr,qr)},s=()=>{d.value&&clearTimeout(d.value),d.value=void 0},u=h=>{const E=n.props.brightnessMax-n.props.brightnessMin,N=(h-n.props.brightnessMin)/E;return Math.round(N*100)},f=h=>h?"ON":"OFF",p=Pn.useStore(),b=c.inject("$dataTracker"),y=c.inject("$socket");b(n.id);const O=c.ref(void 0);c.watch(p.state.data,()=>{O.value=p.state.data.messages[n.id]});const k=c.ref(r()),x=c.ref(r()),v=c.ref(i()),d=c.ref(void 0),g=c.ref(new Date),A=c.ref(null),w=c.computed(()=>v.value.direction==="none"&&!d.value?c.reactive(k.value):c.reactive(x.value)),T=c.computed(()=>w.value.state?"0%":"calc(60% - 16px)"),K=c.computed(()=>w.value.state?["fas","lightbulb"]:["far","lightbulb"]),z=c.ref("#ffffff"),Ot=()=>{let h=(2700-tt)/e;if(n.props.wtype===_.DimmTemp){const ct=(Math.min(St,Math.max(w.value.temp,St))-tt)/e;h=Math.max(0,Math.min(1,ct))}const E=Math.min(255,Math.max(173,Math.round(255*(1-h)+173*h))),P=Math.min(216,Math.max(193,Math.round(193*(1-h)+216*h))),N=Math.min(255,Math.max(67,Math.round(67*(1-h)+255*h)));z.value=`rgb(${E},${P},${N})`};c.watch(()=>w.value.temp,Ot),Ot();const wn=c.ref("0");c.watch([()=>w.value.level,()=>w.value.state],()=>{let h=0;return(n.props.wtype===_.Dimm||n.props.wtype===_.DimmTemp)&&(h=w.value.state?u(w.value.level):0),wn.value=h.toString()}),c.watch(()=>O.value,()=>{O.value&&O.value.payload&&(k.value={state:!!O.value.payload.state,level:O.value.payload.level||n.props.brightnessMin,temp:O.value.payload.temp||tt})});const Sn=h=>{if(!A.value)return;s();const E=A.value.getBoundingClientRect();v.value={direction:"notDecided",begin:{start:{x:"touches"in h?h.touches[0].clientX:h.clientX,y:"touches"in h?h.touches[0].clientY:h.clientY},rect:E,ballast:{state:k.value.state,level:k.value.level,temp:k.value.temp}}},x.value={state:k.value.state,level:k.value.level,temp:k.value.temp},document.addEventListener("mousemove",kt),document.addEventListener("mouseup",Et),document.addEventListener("touchmove",kt),document.addEventListener("touchend",Et)},kt=h=>{switch(v.value.direction){case"none":return;case"notDecided":Jr(h);case"horizontal":ti(h);break;case"vertical":ei(h);break;case"invalid":kn();break}},Et=h=>{var E;if(v.value.direction==="notDecided")if(n.props.wtype===_.OnOff)x.value.state=!k.value.state,x.value.level=x.value.state?n.props.brightnessMax:0;else{const P="touches"in h?h.touches[0].clientY:h.clientY,N=(E=A.value)==null?void 0:E.getBoundingClientRect();let Pt=P-((N==null?void 0:N.top)||0),ct=1-Math.abs(Pt)/((N==null?void 0:N.height)||1),En=n.props.brightnessMin+Math.round((n.props.brightnessMax-n.props.brightnessMin)*ct);x.value.state=ct>.1,ct>.9&&(En=n.props.brightnessMax),x.value.level=x.value.state?En:n.props.brightnessMin}On(!0),o(),kn()},On=h=>{const E=new Date;if(E.getTime()-g.value.getTime()>Kr||h){const P={event:"set",value:{level:x.value.state?n.props.brightnessMax:0,state:x.value.state,temp:0}};(n.props.wtype===_.Dimm||n.props.wtype===_.DimmTemp)&&(P.value.level=x.value.level),n.props.wtype===_.DimmTemp&&(P.value.temp=x.value.temp),(P.value.state!==k.value.state||P.value.level!==k.value.level||P.value.temp!==k.value.temp)&&y.emit("widget-change",n.id,{payload:P}),g.value=E}};c.watch(x.value,()=>{On()});const Zr=()=>{s()},Jr=h=>{const E=a(h);if(n.props.wtype===_.OnOff){v.value.direction="invalid";return}E.y===0&&E.x===0||(n.props.wtype===_.DimmTemp?v.value.direction=Math.abs(E.x)>Math.abs(E.y)?"horizontal":"vertical":v.value.direction="vertical")},ti=h=>{const P=a(h).x/v.value.begin.rect.width;x.value.temp=Math.max(tt,Math.min(St,v.value.begin.ballast.temp-Math.round(P*e)))},ei=h=>{const E=a(h),P=v.value.begin.ballast.level+Math.round(E.y/v.value.begin.rect.height*(n.props.brightnessMax-n.props.brightnessMin));x.value.level=Math.max(n.props.brightnessMin,Math.min(n.props.brightnessMax,P)),x.value.state=!(!P||P<n.props.brightnessMin)},kn=()=>{v.value=i(),document.removeEventListener("mousemove",kt),document.removeEventListener("mouseup",Et),document.removeEventListener("touchmove",kt),document.removeEventListener("touchend",Et)};return(h,E)=>(c.openBlock(),c.createElementBlock("div",Gr,[c.createElementVNode("div",Xr,c.toDisplayString(n.props.label),1),n.props.wtype!==c.unref(_).OnOff?(c.openBlock(),c.createElementBlock("div",Hr,c.toDisplayString(w.value.state?u(w.value.level)+"%":"OFF"),1)):(c.openBlock(),c.createElementBlock("div",Vr,c.toDisplayString(f(w.value.state)),1)),c.createElementVNode("div",{class:"dimmer-bar",ref_key:"dimmerBarElt",ref:A,onMousedown:Sn,onTouchstart:Sn},[n.props.wtype!==c.unref(_).OnOff?(c.openBlock(),c.createElementBlock("div",{key:0,class:"dimmer-fill",style:c.normalizeStyle({height:wn.value+"%",backgroundColor:z.value})},null,4)):c.createCommentVNode("",!0),n.props.wtype!==c.unref(_).OnOff?(c.openBlock(),c.createBlock(c.unref(An),{key:1,icon:K.value,class:"lightbulb-icon"},null,8,["icon"])):c.createCommentVNode("",!0),n.props.wtype===c.unref(_).OnOff?(c.openBlock(),c.createElementBlock("div",{key:2,class:"dimmer-switch",style:c.normalizeStyle({top:T.value})},[c.createVNode(c.unref(An),{icon:K.value,class:"lightbulb-icon"},null,8,["icon"])],4)):c.createCommentVNode("",!0)],544)]))}});Y.DimmLight=Qr,Object.defineProperty(Y,Symbol.toStringTag,{value:"Module"})});
